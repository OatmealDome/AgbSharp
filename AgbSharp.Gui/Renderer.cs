...
void main()
{
    fsout_color =  texture(sampler2D(SurfaceTexture, SurfaceSampler), fsin_texCoords);
        ...
        private void CreateResources()
        {
            ...
            RenderTexture = resourceFactory.CreateTexture(new TextureDescription(240, 160, 1, 1, 1, PixelFormat.R8_G8_B8_A8_UNorm, TextureUsage.Sampled, TextureType.Texture2D));
        ...
        public void Draw(byte[] framebuffer)
        {
            unsafe
            {
                ...
                {
                    GfxDevice.UpdateTexture(RenderTexture, (IntPtr)texDataPtr, 4 * 240 * 160, 0, 0, 0, 240, 160, 1, 0, 0);
                }
            }
